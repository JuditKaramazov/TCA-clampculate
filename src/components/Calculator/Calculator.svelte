...
<details-utils animate>
  <details class={styles.liveExample} style="--variable-value: {result}">
    <summary>Live example</summary>
    <div>
      <p style="font-size:var(--variable-value)" contenteditable="true">
        Here's <b>the text</b> - and you can try the formula on me! Remember that 
        0 and negative numbers set as the minimum value will make me invisible, 
        eh?
      </p>
    </div>
  </details>
